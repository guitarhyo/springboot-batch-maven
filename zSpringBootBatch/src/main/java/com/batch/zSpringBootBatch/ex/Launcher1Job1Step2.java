...
public class Launcher1Job1Step2 { //http://www.javainuse.com/spring/bootbatch 참고
...
//	@Scheduled(cron = "3 * * * * *") //사용시 주석을 풀자
	 ...
	 */
	@Bean
	public Step baseStep1() { //chunk 큰덩어리 프로세스단위
...
//				.writer(sampleItemWriter1())
	...
	@Bean
	public Step baseStep2() { //chunk 큰덩어리 프로세스단위
